...
import { Lock, Mail, Loader2, Building, User, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="relative flex min-h-screen items-center justify-center bg-slate-900 px-4 py-12 overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-8 rounded-3xl border border-slate-800 bg-slate-900/50 backdrop-blur-xl p-8 shadow-2xl z-10 animate-slide-up">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-extrabold tracking-tight text-white">Create your business</h2>
          <p className="mt-2 text-sm text-slate-400">
            Launch CloudPOS for your stores today
          </p>
        </div>
        ...
        <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            {/* Business Name */}
            <div>
              <label className="block text-xs font-semibold text-slate-300 uppercase mb-2">Company / Store Name</label>
            ...
            {/* Owner Name */}
            <div>
              <label className="block text-xs font-semibold text-slate-300 uppercase mb-2">Owner Name</label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 flex items-center pl-3.5 text-slate-500">
